...
import 'package:banksampah/perdataan/layanan/database_service.dart';
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text('Age: ${dog.waktu.toString()}, Color: '),
                      Text('Age: ${dog.catatan.toString()}, Color: '),
                    ],
                  ),
                ],
              ),
